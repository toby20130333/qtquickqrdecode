#ifndef DDQRDecoder_H
#define DDQRDecoder_H
...
class
        ...
        QZXINGSHARED_EXPORT
#endif
 DDQRDecoder : public QObject
{
    Q_OBJECT
    Q_DISABLE_COPY(DDQRDecoder)
...
public:
    ...
    DDQRDecoder(QObject *parent = NULL);

    DDQRDecoder(DecoderFormat decodeHints, QObject *parent = NULL);
    ...
    {
        qmlRegisterType<DDQRDecoder>("DDQRDecoder", 1, 0, "DDQRDecoder");
    }
#endif
